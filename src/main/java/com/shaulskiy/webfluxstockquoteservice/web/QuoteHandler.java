package com.shaulskiy.webfluxstockquoteservice.web;

import com.shaulskiy.webfluxstockquoteservice.model.Quote;
import com.shaulskiy.webfluxstockquoteservice.service.QuoteGeneratorService;
...
public class QuoteHandler {
    ...
    public Mono<ServerResponse> streamQuotes(ServerRequest request){
        return ok()
                ...
                .body(this.quoteGeneratorService.fetchQuoteStream(Duration.ofMillis(50)), Quote.class);
    }
